...
const adaptFullOfferToClient = (offerInstance, authorInstance) => {
  const offer = offerInstance.get({ plain: true });
  const author = authorInstance ? authorInstance.get({ plain: true }) : offer.author;
